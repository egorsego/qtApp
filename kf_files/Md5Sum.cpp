...
//void CMd5Sum::update(void* pData, size_t dwSize)
//{
//	MD5Update(reinterpret_cast<unsigned char*>(pData), dwSize);
//}
...
void CMd5Sum::Decode (UINT4* output, unsigned char* input, unsigned int len)
{
